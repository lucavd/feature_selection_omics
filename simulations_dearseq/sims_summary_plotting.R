...
#### Data MGMT ----
res <- readRDS("NB_NBnonlin_sims/NB_NonLin_sims_12072018.rds")
load("SEQCresampling_sims/aggregatedResults_permpe_12122018.RData")
...
res2plot <- rbind.data.frame(res2plot, temp[, colnames(res2plot)], res_nb_singhania)

setting_fullname <- c(
  nonlin = "Nonlinear",
  nb = "Negative Binomial",
  seqc_rs = "SEQC resampling + Gaussian noise",
  nb_sin = "Negative Binomial Singhania"
)
